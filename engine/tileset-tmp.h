...
public:
  ...
  //! Get Tiles to renderer based on screen size and location and then it renders them given the Engine.
  vector<Tile> renderTiles(Engine e);
  //! Get tiles to renderer based on screen size, location, and given tile width and height and then it renders them given the Engine.
  vector<Tile> renderTiles(int w, int h, Engine e);
