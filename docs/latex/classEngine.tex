...
void \hyperlink{classEngine_aae435925ba83db0788ce65e0e8e41f4c}{draw} (const char $\ast$text, int x, int y, int r, int g, int b, char $\ast$font\+\_\+path)\hypertarget{classEngine_aae435925ba83db0788ce65e0e8e41f4c}{}\label{classEngine_aae435925ba83db0788ce65e0e8e41f4c}
...
\begin{DoxyCode}
114                     \{
115   \textcolor{comment}{//simulationTime += 16;}
116   \textcolor{comment}{//if(simulationTime < realTime) \{ fps = true; \} else \{ fps = false; \}}
117   \textcolor{keywordflow}{if}(glMode) \{
118    glClear( GL\_COLOR\_BUFFER\_BIT | GL\_DEPTH\_BUFFER\_BIT);
119    glMatrixMode( GL\_MODELVIEW );
120    glLoadIdentity( );
121    gluLookAt(glView[0],glView[1],glView[2],glView[3],glView[4],glView[5],glView[6],glView[7],glView[8]);
122   \}
123 \}
\end{DoxyCode}
