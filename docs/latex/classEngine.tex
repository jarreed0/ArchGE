...
\begin{DoxyCode}
113                     \{
114   \textcolor{comment}{//simulationTime += 16;}
115   \textcolor{comment}{//if(simulationTime < realTime) \{ fps = true; \} else \{ fps = false; \}}
116   \textcolor{keywordflow}{if}(glMode) \{
117    glClear( GL\_COLOR\_BUFFER\_BIT | GL\_DEPTH\_BUFFER\_BIT);
118    glMatrixMode( GL\_MODELVIEW );
119    glLoadIdentity( );
120    gluLookAt(glView[0],glView[1],glView[2],glView[3],glView[4],glView[5],glView[6],glView[7],glView[8]);
121   \}
122 \}
\end{DoxyCode}
